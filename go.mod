...
require (
	...
	github.com/googlecloudplatform/compute-class-api v0.0.0-20260917140836-fbb3f5947cba
	...
	sigs.k8s.io/cluster-autoscaler v0.0.0-k8s.v1.37.0.0.20260922131812-e7695eb8721a
...
replace sigs.k8s.io/cluster-autoscaler => sigs.k8s.io/cluster-autoscaler v0.0.0-k8s.v1.37.0.0.20260922131812-e7695eb8721a
