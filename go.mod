...
require (
	...
	sigs.k8s.io/cluster-autoscaler v0.0.0-20260811120518-991000421cbb
...
replace (
	...
	k8s.io/kubernetes => k8s.io/kubernetes v1.37.0-rc.0
	...
	k8s.io/streaming => k8s.io/streaming v0.37.0-rc.0
)
