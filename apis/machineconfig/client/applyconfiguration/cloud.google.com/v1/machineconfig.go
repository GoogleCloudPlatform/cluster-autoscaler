...
type MachineConfigApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	...
	Status                           *MachineConfigStatusApplyConfiguration `json:"status,omitempty"`
}
...
func (b *MachineConfigApplyConfiguration) WithStatus(value *MachineConfigStatusApplyConfiguration) *MachineConfigApplyConfiguration {
	b.Status = value
	return b
}
