...
import (
	...
	scheme "k8s.io/gke-autoscaling/cluster-autoscaler/apis/machineconfig/client/clientset/versioned/scheme"
...
type MachineConfigInterface interface {
	...
	UpdateStatus(ctx context.Context, machineConfig *v1.MachineConfig, opts metav1.UpdateOptions) (*v1.MachineConfig, error)
	...
	Apply(ctx context.Context, machineConfig *cloudgooglecomv1.MachineConfigApplyConfiguration, opts metav1.ApplyOptions) (result *v1.MachineConfig, err error)
	ApplyStatus(ctx context.Context, machineConfig *cloudgooglecomv1.MachineConfigApplyConfiguration, opts metav1.ApplyOptions) (result *v1.MachineConfig, err error)
...
func newMachineConfigs(c *CloudV1Client) *machineConfigs {
...
func (c *machineConfigs) UpdateStatus(ctx context.Context, machineConfig *v1.MachineConfig, opts metav1.UpdateOptions) (result *v1.MachineConfig, err error) {
	result = &v1.MachineConfig{}
	err = c.client.Put().
		Resource("machineconfigs").
		Name(machineConfig.Name).
...
func (c *machineConfigs) Apply(ctx context.Context, machineConfig *cloudgooglecomv1.MachineConfigApplyConfiguration, opts metav1.ApplyOptions) (result *v1.MachineConfig, err error) {
...
func (c *machineConfigs) ApplyStatus(ctx context.Context, machineConfig *cloudgooglecomv1.MachineConfigApplyConfiguration, opts metav1.ApplyOptions) (result *v1.MachineConfig, err error) {
	if machineConfig == nil {
		return nil, fmt.Errorf("machineConfig provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
