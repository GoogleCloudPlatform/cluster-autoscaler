...
import (
	...
	"k8s.io/gke-autoscaling/cluster-autoscaler/apis/machineconfig/client/clientset/versioned/scheme"
...
func (c *CloudV1Client) MachineConfigs() MachineConfigInterface {
