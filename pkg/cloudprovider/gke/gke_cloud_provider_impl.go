...
func (p *gkeCloudProviderImpl) IsExtendedFallbacksEnabled() bool {
...
// IsExtendedFallbacksEnabled returns whether extended fallbacks are enabled for this MIG.
func (mig *GkeMig) IsExtendedFallbacksEnabled() bool {
	return mig.gkeManager.IsExtendedFallbacksEnabled()
}
