...
const (
	...
	maxConcurrentRefreshShortLivedUpgrade = 15
...
type gkeManagerImpl struct {
	...
	dataplaneV2Enabled              atomic.Bool
...
func (m *gkeManagerImpl) refreshGkeResources() error {
	...
	m.dataplaneV2Enabled.Store(cluster.DataplaneV2Enabled)
	...
	m.NewNodePoolDaemonSetConditions = &DaemonSetConditions{
		...
		DisableWIImagePullForRiptide: m.managerOptions.DisableWIImagePullForRiptide,
...
func (m *gkeManagerImpl) refreshShortLivedUpgradeInProgress() {
	...
	eg.SetLimit(maxConcurrentRefreshShortLivedUpgrade)
...
func (m *gkeManagerImpl) IsDataplaneV2Enabled() bool {
	return m.dataplaneV2Enabled.Load()
}
...
// IsExtendedFallbacksEnabled returns true if extended fallbacks are enabled.
func (m *gkeManagerImpl) IsExtendedFallbacksEnabled() bool {
	if m.resizableVmAutoprovisioningProvider == nil {
		return false
	}
	return m.resizableVmAutoprovisioningProvider.IsExtendedFallbacksEnabled()
}
