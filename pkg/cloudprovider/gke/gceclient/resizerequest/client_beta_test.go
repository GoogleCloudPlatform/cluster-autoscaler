...
const (
	resizeRequestCreationBetaResponse = `{
	"kind": "compute#operation",
  "id": "6684860318710205276",
  "name": "operation-1669031976964-5edf9ca1b11e5-b4d28da7-c9b8624c",
  "zone": "https://www.googleapis.com/compute/beta/projects/test-gke-dev/zones/us-west4-a",
  "operationType": "compute.instanceGroupManagerResizeRequests.insert",
  "targetLink": "https://www.googleapis.com/compute/beta/projects/test-gke-dev/zones/us-west4-a/instanceGroupManagers/mig-name/resizeRequests/qwert12345qwert12345qwert12345asdfg09876asdfg09876asdfg09876lkj",
  ...
  "selfLink": "https://www.googleapis.com/compute/beta/projects/test-gke-dev/zones/us-west4-a/operations/operation-1669031976964-5edf9ca1b11e5-b4d28da7-c9b8624c",
  "selfLinkWithId": "https://www.googleapis.com/compute/beta/projects/test-gke-dev/zones/us-west4-a/operations/6684860318710205276"
}`
	operationRunningBetaResponse = `{
  "name": "operation-1669031976964-5edf9ca1b11e5-b4d28da7-c9b8624c",
  "zone": "us-west4-a",
  "operationType": "compute.instanceGroupManagerResizeRequests.insert",
  "status": "RUNNING",
  "selfLink": "https://www.googleapis.com/compute/beta/projects/test-gke-dev/zones/us-west4-a/operations/operation-1669031976964-5edf9ca1b11e5-b4d28da7-c9b8624c",
  "targetLink": "https://www.googleapis.com/compute/beta/projects/test-gke-dev/zones/us-west4-a/instanceGroupManagers/mig-name/resizeRequests/qwert12345q",
  "startTime": "2022-11-23T09:54:26.148507311Z",
  "endTime": "2022-11-23T09:54:35.124878859Z"
}`
	operationDoneBetaResponse = `{
  "name": "operation-1669031976964-5edf9ca1b11e5-b4d28da7-c9b8624c",
  "zone": "us-west4-a",
  "operationType": "compute.instanceGroupManagerResizeRequests.insert",
  "status": "DONE",
  ...
  "endTime": "2022-11-23T09:54:35.124878859Z"
	...
	deleteResizeRequestBetaResponse = `{
	"kind": "compute#operation",
	...
	"insertTime": "2022-11-23T07:01:07.788-08:00",
	"startTime": "2022-11-23T07:01:07.793-08:00",
	"selfLink": "https://www.googleapis.com/compute/beta/projects/test-gke-dev/zones/us-west4-a/operations/operation-1677059387561-5f546d11017de-c1697fc0-cac83e49",
	"selfLinkWithId": "https://www.googleapis.com/compute/beta/projects/test-gke-dev/zones/us-west4-a/operations/845011320898608083"
  }`
	deleteOperationRunningBetaResponse = `{
	"name": "operation-1677059387561-5f546d11017de-c1697fc0-cac83e49",
	"zone": "us-west4-a",
	"operationType": "compute.instanceGroupManagerResizeRequests.delete",
	"status": "RUNNING",
	...
	deleteOperationDoneBetaResponse = `{
	"name": "operation-1677059387561-5f546d11017de-c1697fc0-cac83e49",
	"zone": "us-west4-a",
	"operationType": "compute.instanceGroupManagerResizeRequests.delete",
	"status": "DONE",
	...
	deleteOperationDoneWithErrorsBetaResponse = `{
	"name": "operation-1677059387561-5f546d11017de-c1697fc0-cac83e49",
	"zone": "us-west4-a",
	"operationType": "compute.instanceGroupManagerResizeRequests.delete",
	"status": "DONE",
	...
	retryDeleteResizeRequestBetaResponse = `{
	"kind": "compute#operation",
	...
	"insertTime": "2022-11-23T07:01:07.788-08:00",
	"startTime": "2022-11-23T07:01:07.793-08:00",
	"selfLink": "https://www.googleapis.com/compute/beta/projects/test-gke-dev/zones/us-west4-a/operations/operation-1697108668456-60782e7541cb2-6686cfad-8f925b38",
	"selfLinkWithId": "https://www.googleapis.com/compute/beta/projects/test-gke-dev/zones/us-west4-a/operations/678346782376843267"
  }`
	retryDeleteOperationDoneBetaResponse = `{
	"name": "operation-1697108668456-60782e7541cb2-6686cfad-8f925b38",
	"zone": "us-west4-a",
	"operationType": "compute.instanceGroupManagerResizeRequests.delete",
	"status": "DONE",
	...
	cancelResizeRequestBetaResponse = `{
	"kind": "compute#operation",
	...
	"selfLink": "https://www.googleapis.com/compute/beta/projects/test-gke-dev/zones/us-west4-a/operations/operation-1704965670300-60ea84121ea94-fd8d8370-461c8976",
	"selfLinkWithId": "https://www.googleapis.com/compute/beta/projects/test-gke-dev/zones/us-west4-a/operations/6167131165371271367"
  }`
	cancelOperationRunningBetaResponse = `{
	"name": "operation-1704965670300-60ea84121ea94-fd8d8370-461c8976",
	"zone": "us-west4-a",
	"operationType": "compute.instanceGroupManagerResizeRequests.cancel",
	"status": "RUNNING",
	...
	cancelOperationDoneBetaResponse = `{
	"name": "operation-1704965670300-60ea84121ea94-fd8d8370-461c8976",
	"zone": "us-west4-a",
	"operationType": "compute.instanceGroupManagerResizeRequests.cancel",
	"status": "DONE",
	"selfLink": "https://www.googleapis.com/compute/beta/projects/test-gke-dev/zones/us-west4-a/operations/operation-operation-1704965670300-60ea84121ea94-fd8d8370-461c8976",
	"targetLink": "https://www.googleapis.com/compute/beta/projects/test-gke-dev/zones/us-west4-a/instanceGroupManagers/mig-name/resizeRequests/qwert12345q",
	"startTime": "2022-11-23T07:00:11.793-08:00",
	"endTime": "2022-11-23T07:00:11.799-08:00"
  }`
	cancelOperationDoneWithConditionNotMetErrorBetaResponse = `{
	"name": "operation-1704965670300-60ea84121ea94-fd8d8370-461c8976",
	"zone": "us-west4-a",
	"operationType": "compute.instanceGroupManagerResizeRequests.cancel",
	"status": "DONE",
...
func TestCreateAtomicResizeRequestBeta(t *testing.T) {
	t.Parallel()
	...
	defer server.Close()
	client := &http.Client{}
	g, err := NewResizeRequestClientBeta(client, projectID, "user agent", server.URL, ResizeRequestModeAtomic)
	if err != nil {
	...
	server.On("handle", "/projects/project1/zones/us-west4-a/instanceGroupManagers/mig-name/resizeRequests").Return(resizeRequestCreationBetaResponse).Once()
	server.On("handle", "/projects/project1/zones/us-west4-a/operations/operation-1669031976964-5edf9ca1b11e5-b4d28da7-c9b8624c").Return(operationRunningBetaResponse).Once()
	server.On("handle", "/projects/project1/zones/us-west4-a/operations/operation-1669031976964-5edf9ca1b11e5-b4d28da7-c9b8624c").Return(operationDoneBetaResponse).Once()
...
func TestAdvanceResizeRequestCleanUpBeta(t *testing.T) {
	t.Parallel()
	...
	defer server.Close()
	client := &http.Client{}
	g, err := NewResizeRequestClientBeta(client, "test-gke-dev", "user agent", server.URL, ResizeRequestModeAtomic)
	if err != nil {
		t.Fatalf("Received error when creating the client: %v", err)
	}
	...
	server.On("handle", "/projects/test-gke-dev/zones/us-west4-a/instanceGroupManagers/mig-name/resizeRequests/qwert12345q").Return(deleteResizeRequestBetaResponse).Once()
...
func TestDeleteTerminalResizeRequestBetaLongRunningOperation(t *testing.T) {
	t.Parallel()
	...
	defer server.Close()
	client := &http.Client{}
	g, err := NewResizeRequestClientBeta(client, projectID, "user agent", server.URL, ResizeRequestModeQueued)
	if err != nil {
		t.Fatalf("Received error when creating the client: %v", err)
	}
	...
	server.On("handle", "/projects/test-gke-dev/zones/us-west4-a/operations/operation-1677059387561-5f546d11017de-c1697fc0-cac83e49").Return(deleteOperationRunningBetaResponse).Once()
	err = g.AdvanceResizeRequestCleanUp(context.Background(), resizeRequestTerminal)
	assert.NoError(t, err)

	// Delete operation finished with errors, we retry with new delete operation
	server.On("handle", "/projects/test-gke-dev/zones/us-west4-a/operations/operation-1677059387561-5f546d11017de-c1697fc0-cac83e49").Return(deleteOperationDoneWithErrorsBetaResponse).Once()
	server.On("handle", "/projects/test-gke-dev/zones/us-west4-a/instanceGroupManagers/mig-name/resizeRequests/qwert12345q").Return(retryDeleteResizeRequestBetaResponse).Once()
	err = g.AdvanceResizeRequestCleanUp(context.Background(), resizeRequestTerminal)
	assert.NoError(t, err)

	// The Resize Request is still present, check the new operation status
	server.On("handle", "/projects/test-gke-dev/zones/us-west4-a/operations/operation-1697108668456-60782e7541cb2-6686cfad-8f925b38").Return(retryDeleteOperationDoneBetaResponse).Once()
	err = g.AdvanceResizeRequestCleanUp(context.Background(), resizeRequestTerminal)
	assert.NoError(t, err)
...
func TestDeleteWithCancelActiveResizeRequestBeta(t *testing.T) {
	t.Parallel()
	...
	server.On("handle", "/projects/test-gke-dev/zones/us-west4-a/instanceGroupManagers/mig-name/resizeRequests/qwert12345q/cancel").Return(cancelResizeRequestBetaResponse).Once()
	...
	server.On("handle", "/projects/test-gke-dev/zones/us-west4-a/operations/operation-1704965670300-60ea84121ea94-fd8d8370-461c8976").Return(cancelOperationDoneBetaResponse).Once()
	server.On("handle", "/projects/test-gke-dev/zones/us-west4-a/instanceGroupManagers/mig-name/resizeRequests/qwert12345q").Return(deleteResizeRequestBetaResponse).Once()
	err = g.AdvanceResizeRequestCleanUp(context.Background(), resizeRequest)
	assert.NoError(t, err)
	...
	server.On("handle", "/projects/test-gke-dev/zones/us-west4-a/operations/operation-1677059387561-5f546d11017de-c1697fc0-cac83e49").Return(deleteOperationDoneBetaResponse).Once()
	err = g.AdvanceResizeRequestCleanUp(context.Background(), resizeRequest)
	assert.NoError(t, err)
...
func TestAdvanceResizeRequestCleanUpBeta_WithCancelTriggerFail(t *testing.T) {
	t.Parallel()
	...
	server.On("handle", "/projects/test-gke-dev/zones/us-west4-a/instanceGroupManagers/mig-name/resizeRequests/qwert12345q").Return(200, deleteResizeRequestBetaResponse).Once()
	err = g.AdvanceResizeRequestCleanUp(context.Background(), resizeRequest)
	assert.NoError(t, err)

	// The Resize Request is still present, check the new operation status - the operation is done, we successfully deleted the Resize Request
	server.On("handle", "/projects/test-gke-dev/zones/us-west4-a/operations/operation-1677059387561-5f546d11017de-c1697fc0-cac83e49").Return(200, deleteOperationDoneBetaResponse).Once()
	err = g.AdvanceResizeRequestCleanUp(context.Background(), resizeRequest)
	assert.NoError(t, err)
...
func TestAdvanceResizeRequestCleanUpBeta_WithCancelFinishFail(t *testing.T) {
	t.Parallel()
	...
	server.On("handle", "/projects/test-gke-dev/zones/us-west4-a/operations/operation-1704965670300-60ea84121ea94-fd8d8370-461c8976").Return(cancelOperationDoneWithConditionNotMetErrorBetaResponse).Once()
	err = g.AdvanceResizeRequestCleanUp(context.Background(), resizeRequest)
	assert.NoError(t, err)
...
func TestFailedCancelAndRetryBeta(t *testing.T) {
	t.Parallel()
	...
	defer server.Close()
	client := &http.Client{}
	g, err := NewResizeRequestClientBeta(client, "test-gke-dev", "user agent", server.URL, ResizeRequestModeQueued)
	if err != nil {
		t.Fatalf("Received error when creating the client: %v", err)
	}
...
func TestResizeRequestNameBeta(t *testing.T) {
	t.Parallel()
...
func TestResizeRequestsBeta(t *testing.T) {
	t.Parallel()
	...
	tests := []struct {
		name           string
		zone           string
		resizeRequests [][]resizeRequestResponseMock
				...
				{
					{
						...
						state:             "ACCEPTED",
						requestedRunDuration: &gce_api_beta.Duration{
							Nanos:   1232,
							Seconds: 36000,
						},
					},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			server := test_util.NewHttpServerMock()
			defer server.Close()
			client := newTestResizeRequestClientBeta(t, projectID, server.URL)

			url := fmt.Sprintf("/projects/%s/zones/%s/instanceGroupManagers/%s/resizeRequests", projectID, tt.zone, migName)
			resizeRequestListResponses := fillAtomicResizeRequestListResponseTemplate(tt.resizeRequests)
			...
			if (err != nil) != tt.wantErr {
				t.Errorf("resizeRequestClientBeta.ResizeRequests() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("resizeRequestClientBeta.ResizeRequests() = \n%+v\nwant: \n%+v", got, tt.want)
			}
			mock.AssertExpectationsForObjects(t, server)
		})
	}
...
func TestRegisterFailedResizeRequestsCreation(t *testing.T) {
	t.Parallel()
...
func TestResetFailedResizeRequestsCreation(t *testing.T) {
	t.Parallel()
...
type resizeRequestResponseMock struct {
	id                   int
	name                 string
	resizeBy             int
...
func fillAtomicResizeRequestListResponseTemplate(resizeRequestsPages [][]resizeRequestResponseMock) []string {
	...
	for i, resizeRequests := range resizeRequestsPages {
		...
		for _, rr := range resizeRequests {
			items = append(items, fillResizeRequestResponseTemplate(rr))
		}
...
func fillResizeRequestResponseTemplate(rr resizeRequestResponseMock) string {
	const (
...
func newTestResizeRequestClientBeta(t *testing.T, projectID, url string) *resizeRequestClientBeta {
	httpClient := &http.Client{}
	client, err := NewResizeRequestClientBeta(httpClient, projectID, "", url, ResizeRequestModeAtomic)
	if err != nil {
