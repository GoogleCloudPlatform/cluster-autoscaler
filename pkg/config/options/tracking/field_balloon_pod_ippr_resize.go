...
var balloonPodIpprResizeEnabledField = trackedField{
	name: "BalloonPodIpprResizeEnabled",
	valueEqual: func(optsA, optsB internalopts.AutoscalingOptions) bool {
		return optsA.BalloonPodIpprResizeEnabled == optsB.BalloonPodIpprResizeEnabled
	},
	getValueStr: func(opts internalopts.AutoscalingOptions) string {
		return fmt.Sprintf("%v", opts.BalloonPodIpprResizeEnabled)
	},
