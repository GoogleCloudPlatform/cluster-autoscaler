...
// WithOperationMode sets the OperationMode field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the OperationMode field is set to the value of the last call.
func (b *ProvisioningRequestSpecApplyConfiguration) WithOperationMode(value string) *ProvisioningRequestSpecApplyConfiguration {
	b.OperationMode = &value
	return b
}
