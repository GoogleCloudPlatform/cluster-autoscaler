...
var _ GkeMigWrapper = &FakeGkeMigWrapper{}

type FakeGkeMigWrapper struct {
	NPName                    string
	PoolSpec                  *gkeclient.NodePoolSpec
	IncreaseSizeError         error
	UpdateNodePoolLabelsError error
}

func (mig *FakeGkeMigWrapper) NodePoolName() string {
	return mig.NPName
}
...
func (mig *FakeGkeMigWrapper) UpdateNodePoolLabels(labels map[string]string) error {
	return mig.UpdateNodePoolLabelsError
}
