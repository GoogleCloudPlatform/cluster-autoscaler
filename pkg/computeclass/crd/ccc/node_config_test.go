		...
		},
		{
			...
			nodeSystemConfig: &ccc_api.NodeSystemConfig{
				KubeletConfig: &ccc_api.KubeletConfig{
					...
					ContainerLogMaxWorkers:             int64Ptr(4),
					ContainerLogMonitorInterval:        stringPtr("10s"),
					...
					InsecureKubeletReadonlyPortEnabled: boolPtr(true),
			...
			expected: []rules.RuleOption{
				...
				rules.WithContainerLogMaxWorkersRule(4),
				rules.WithContainerLogMonitorIntervalRule("10s"),
				...
				rules.WithInsecureKubeletReadonlyPortEnabledRule(true),
