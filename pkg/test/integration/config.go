...
import (
	...
	ossconfig "sigs.k8s.io/cluster-autoscaler/pkg/config"
...
func WithEnhancedCrdStatusReportingEnabled() Option[*config.AutoscalingOptions] {
	return func(o *config.AutoscalingOptions) *config.AutoscalingOptions {
		o.EnhancedCrdStatusReporting = true
		return o
	}
}
...
func WithDaemonSetMutationEnabled(enabled bool) Option[*config.AutoscalingOptions] {
	return func(o *config.AutoscalingOptions) *config.AutoscalingOptions {
		o.InternalOptions.DaemonSetMutationEnabled = enabled
		return o
	}
}
...
// WithEnhancedCrdStatusReporting enables or disables Enhanced CRD Status Reporting.
func WithEnhancedCrdStatusReporting(enabled bool) Option[*config.AutoscalingOptions] {
	return func(o *config.AutoscalingOptions) *config.AutoscalingOptions {
		o.EnhancedCrdStatusReporting = enabled
		return o
	}
}

// WithCccNodeAutoprovisioningEnabled enables CCC Node Autoprovisioning.
func WithCccNodeAutoprovisioningEnabled() Option[*config.AutoscalingOptions] {
	return func(o *config.AutoscalingOptions) *config.AutoscalingOptions {
		o.CccNodeAutoprovisioningEnabled = true
		return o
	}
}

// WithAutoscalerVisibility enables or disables CA visibility events.
func WithAutoscalerVisibility(enabled bool) Option[*config.AutoscalingOptions] {
	return func(o *config.AutoscalingOptions) *config.AutoscalingOptions {
		o.UseAutoscalerVisibility = enabled
		return o
	}
}

// WithEmitNoScaleUpCAVizEvents enables or disables emitting NoScaleUp visibility events.
...
func WithInitialNodeGroupBackoffDuration(d time.Duration) Option[*config.AutoscalingOptions] {
	return func(o *config.AutoscalingOptions) *config.AutoscalingOptions {
		o.InitialNodeGroupBackoffDuration = d
		return o
	}
}
...
// WithNodePoolLabels adds labels to the node pool config.
...
// WithNodePoolCCCLabel adds the ComputeClass label to the node pool config.
func WithNodePoolCCCLabel(cccName string) Option[*gke_api_beta.NodePool] {
	return WithNodePoolLabels(map[string]string{gkelabels.ComputeClassLabel: cccName})
}

// WithNodePoolTaints adds taints to the node pool config.
...
// WithNodePoolCCCTaint adds the ComputeClass taint to the node pool config.
func WithNodePoolCCCTaint(cccName string) Option[*gke_api_beta.NodePool] {
	return WithNodePoolTaints(&gke_api_beta.NodeTaint{
...
// WithLabels adds labels to the node pool config.
func (b NodePoolBuilder) WithLabels(labels map[string]string) NodePoolBuilder {
	if b.NodePool.Config == nil {
		b.NodePool.Config = &gke_api_beta.NodeConfig{}
	}
	if b.NodePool.Config.Labels == nil {
		b.NodePool.Config.Labels = make(map[string]string)
	}
	for k, v := range labels {
		b.NodePool.Config.Labels[k] = v
	}
	return b
}

// WithLabel sets a single label on the node pool config.
func (b NodePoolBuilder) WithLabel(k, v string) NodePoolBuilder {
	return b.WithLabels(map[string]string{k: v})
}

// WithCCCLabel adds the ComputeClass label to the node pool config.
func (b NodePoolBuilder) WithCCCLabel(cccName string) NodePoolBuilder {
	return b.WithLabel(gkelabels.ComputeClassLabel, cccName)
}

// WithTaints adds taints to the node pool config.
func (b NodePoolBuilder) WithTaints(taints ...*gke_api_beta.NodeTaint) NodePoolBuilder {
	if b.NodePool.Config == nil {
		b.NodePool.Config = &gke_api_beta.NodeConfig{}
	}
	b.NodePool.Config.Taints = append(b.NodePool.Config.Taints, taints...)
	return b
}

// WithCCCTaint adds the ComputeClass taint to the node pool config.
func (b NodePoolBuilder) WithCCCTaint(cccName string) NodePoolBuilder {
	return b.WithTaints(&gke_api_beta.NodeTaint{
		Key:    gkelabels.ComputeClassLabel,
		Value:  cccName,
		Effect: "NO_SCHEDULE",
	})
...
// WithSpot configures the node pool to use Spot VMs.
func (b NodePoolBuilder) WithSpot() NodePoolBuilder {
	if b.NodePool.Config == nil {
		b.NodePool.Config = &gke_api_beta.NodeConfig{}
	}
	b.NodePool.Config.Spot = true
	if b.NodePool.Config.Labels == nil {
		b.NodePool.Config.Labels = make(map[string]string)
	}
	b.NodePool.Config.Labels[gkelabels.ProvisioningLabel] = gkelabels.SpotProvisioningValue
	b.NodePool.Config.Labels[gkelabels.SpotLabel] = gkelabels.PreemptionValue
	return b
}

// WithOptions applies functional options to the node pool builder.
func (b NodePoolBuilder) WithOptions(opts ...Option[*gke_api_beta.NodePool]) NodePoolBuilder {
	Apply(b.NodePool, opts...)
	return b
}
