...
func TestAIZonesFlexAdvisorStockout(t *testing.T) {
	...
	synctest.Test(t, func(t *testing.T) {
		...
		infra.Fakes.FlexAdvisorClient.AddCapacityGuidances(
			fake.NewGuidance(AvailableMachineType).WithZone(aiZone).WithCapacity(0).WithScore(0.5),
			fake.NewGuidance(AvailableMachineType).WithZone(standardZone).WithCapacity(10).WithScore(0.5),
		)
...
func TestAIZonesFlexAdvisorWithCapacity(t *testing.T) {
	...
	synctest.Test(t, func(t *testing.T) {
		...
		infra.Fakes.FlexAdvisorClient.AddCapacityGuidances(
			fake.NewGuidance(AvailableMachineType).WithZone(aiZone).WithCapacity(10).WithScore(0.5),
			fake.NewGuidance(AvailableMachineType).WithZone(standardZone).WithCapacity(10).WithScore(1),
		)
