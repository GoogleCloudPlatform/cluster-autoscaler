...
// IsDemandFungibilityImpactTrackingEnabled returns whether Demand Fungibility Impact Tracking is dynamically enabled.
func IsDemandFungibilityImpactTrackingEnabled(manager Manager) bool {
	if manager == nil {
		return false
	}
