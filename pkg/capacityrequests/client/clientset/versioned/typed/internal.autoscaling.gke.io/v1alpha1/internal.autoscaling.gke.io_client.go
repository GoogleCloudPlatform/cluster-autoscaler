...
// InternalV1alpha1Client is used to interact with features provided by the internal.autoscaling.gke.io group.
type InternalV1alpha1Client struct {
	restClient rest.Interface
}

func (c *InternalV1alpha1Client) CapacityRequests(namespace string) CapacityRequestInterface {
