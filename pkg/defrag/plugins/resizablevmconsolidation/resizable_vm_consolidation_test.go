...
func TestNewCandidate(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			maxCandidateNodeCount: 1,
			resizableNodesSnapshot: operationtracker.ResizableNodesSnapshot{
				"ek-node-1": buildTestResizableNodeObject(2000, 20, 8000, 32),
				"ek-node-2": buildTestResizableNodeObject(6500, 20, 8000, 32),
				"ek-node-3": buildTestResizableNodeObject(6500, 20, 8000, 32),
			},
			nodes: []*v1.Node{
		...
		},
		{
			...
			resizableNodesSnapshot: operationtracker.ResizableNodesSnapshot{
				...
				"ek-node-2": buildTestResizableNodeObject(7000, 10, 7500, 30),
				"ek-node-3": buildTestResizableNodeObject(7000, 10, 7500, 30),
			},
			nodes: []*v1.Node{
				buildTestNodeEk8("ek-node-1", 8000, 32),
				buildTestNodeEk8("ek-node-2", 8000, 32),
		...
		},
		{
			...
			resizableNodesSnapshot: operationtracker.ResizableNodesSnapshot{
				"ek-node-1": buildTestResizableNodeObject(1500, 5, 7500, 30),
				"ek-node-2": buildTestResizableNodeObject(1500, 5, 7500, 30),
				"ek-node-3": buildTestResizableNodeObject(24000, 10, 30000, 120),
			},
			nodes: []*v1.Node{
				buildTestNodeEk8("ek-node-1", 8000, 32),
		...
		{
			name:                  "E4A nodes can be rescheduled and selected as candidates",
			maxCandidateNodeCount: 5,
			resizableNodesSnapshot: operationtracker.ResizableNodesSnapshot{
				"e4a-node-1": buildTestResizableNodeObject(1500, 5, 7500, 30),
				"e4a-node-2": buildTestResizableNodeObject(1500, 5, 7500, 30),
				"ek-node-3":  buildTestResizableNodeObject(24000, 10, 30000, 120),
			},
			nodes: []*v1.Node{
				buildTestNodeE4a8("e4a-node-1", 8000, 32),
				buildTestNodeE4a8("e4a-node-2", 8000, 32),
				buildTestNodeEk32("ek-node-3", 32000, 128),
			},
			podsPerNode: map[string][]*v1.Pod{
				"e4a-node-1": {
					buildTestPod("e4a-node-1-pod", "e4a-node-1", 1500, 5),
					buildTestBalloonPod("e4a-node-1-balloon-pod", "e4a-node-1", 6000, 25),
				},
				"e4a-node-2": {
					buildTestPod("e4a-node-2-pod", "e4a-node-2", 1500, 5),
			...
			nodeNames:                 []string{"e4a-node-1", "e4a-node-2"},
			wantCandidateNodeNames:    []string{"e4a-node-1", "e4a-node-2"},
			wantLatestUnfitNodesCount: 2,
		},
		{
			...
			resizableNodesSnapshot: operationtracker.ResizableNodesSnapshot{
				"ek-node-1": buildTestResizableNodeObject(1500, 5, 7500, 30),
				"ek-node-2": buildTestResizableNodeObject(1500, 5, 7500, 30),
				"ek-node-3": buildTestResizableNodeObject(30000, 10, 1000, 120),
			},
			nodes: []*v1.Node{
				buildTestNodeEk8("ek-node-1", 8000, 32),
				buildTestNodeEk8("ek-node-2", 8000, 32),
	...
	testCases := []struct {
		...
		},
		{
			...
			resizableNodesSnapshot: operationtracker.ResizableNodesSnapshot{
				...
				"ek-node-2": buildTestResizableNodeObject(6000, 10, 7500, 30),
				"ek-node-3": buildTestResizableNodeObject(6000, 10, 7500, 30),
			},
			nodes: []*v1.Node{
				buildTestNodeEk8("ek-node-1", 8000, 32),
				buildTestNodeEk8("ek-node-2", 8000, 32),
		...
		},
		{
			...
			resizableNodesSnapshot: operationtracker.ResizableNodesSnapshot{
				"ek-node-1": buildTestResizableNodeObject(2500, 10, 7500, 30),
				"ek-node-2": buildTestResizableNodeObject(2500, 10, 7500, 30),
				"ek-node-3": buildTestResizableNodeObject(28000, 10, 32000, 120),
			},
			nodes: []*v1.Node{
				buildTestNodeEk8("ek-node-1", 8000, 32),
				buildTestNodeEk8("ek-node-2", 8000, 32),
...
func buildTestNodeE4a8(name string, cpu, memory int64) *v1.Node {
