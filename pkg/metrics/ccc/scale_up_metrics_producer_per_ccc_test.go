...
cluster_autoscaler_cluster_node_provisioning_attempts_count_per_ccc{entity_name="default-ccc",entity_type="ComputeClass"} 2
cluster_autoscaler_cluster_node_provisioning_attempts_count_per_ccc{entity_name="high-cpu",entity_type="ComputeClass"} 3
`
